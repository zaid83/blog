...
class Article extends Model
{
    ...
    public function findFavourites(int $iduser)
    {
     ...
     * Delete favourites
     */
    public function delFavourites(int $iduser, int $article)
    {
     ...
     * Add favourites
     */
    public function addFavourites(int $iduser, int $article)
    {
    ...
    public function checkFav(int $article, int $user)
    {
        $pdo = getPdo();
