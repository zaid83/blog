...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 10 avr. 2023 à 14:12
...
(29, 'Blue Lock', '6433401392f727.45659348.webp', 'Le manga commence avec l\'élimination de la Coupe du monde 2018 du Japon, ce qui incite l\'Union japonaise de football à lancer un programme de surveillance dans les écoles secondaires afin de sélectionner les joueurs qui vont s\'entraîner et se préparer pour la Coupe du monde 2022. Le protagoniste Yoichi Isagi, un membre avancé de son équipe de lycée perd le match qui aurait pu qualifier son équipe pour la finale de Saitama, faute de pouvoir jouer dans les championnats nationaux. Alors qu\'il croyait que tout était perdu, Yoichi reçoit une invitation à rejoindre le programme Blue Lock. ', '2023-04-10 02:55:27', 13, 1, NULL);
...
(13, 'modo230', '$2y$10$0zMIKjz61jzduRxLuZFneuOc70yFfZ8akpxhHKTG2M8lIYxoJTMiS', 'modo@modo.fr', '13.png', '', 2, '0000-00-00 00:00:00'),
(19, 'Durant13', '$2y$10$1zUv5qmCTUYEa4nmTZzhtOvl11H64prnVNjp4hGO/JyMN3gcH/A5u', 'durant@durant.fr', '19.webp', '', 1, '0000-00-00 00:00:00'),
(20, 'Zaid23', '$2y$10$kjkkHxkEe14k5b8fBXrKbOJd4GNAaDxfZZiZ3dq11QCLORjVNazMa', 'zaid@zaid.fr', '20.webp', '', 2, '0000-00-00 00:00:00'),
(21, 'mailtest', '$2y$10$OvxeamKGjzGtfmL.3EDsVuXMXRiYj00f2TF7oLNOb6WolxeUiKtw.', 'heigreikepefu-7243@yopmail.com', 'default.png', 'rufMoY8nytshN0RSzZak', 1, '2023-04-10 13:12:02');
